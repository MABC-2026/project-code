...
8. 사실 목록에 '채용의 성격'이 있으면, 이 회사의 신규취득이 빈자리를 채우는 쪽인지 인원을 늘리는 쪽인지, 신규취득이 몰리는 달이 있는지, 최근 3개월에 달라졌는지를 지원자 관점에서 짚는다.
   - 이렇게_볼_수_있어요 에 이 흐름을 한 문장 넣고, 지원_전에_확인해보세요 에 이 흐름에 맞는 확인 거리를 한 개 이상 넣는다. 예: 빈자리 채우기가 대부분이면 "지원하는 자리가 새로 생긴 자리인지, 누군가 떠난 자리인지", 늘어난 자리가 많으면 "인원이 늘어나는 팀과 직무", 몰린 달이 있으면 "채용이 정해진 시기에 몰리는지".
...
const FORBIDDEN = [
  ...
  "증가 중심", "감소 중심", "드나듦 중심", "중심의 달", "구조조정", "해고", "정년"
];
