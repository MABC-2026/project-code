export default function ExplainCard({ loading, error, data, 진단결과 }:
  { loading: boolean; error: string | null; data: any | null; 진단결과: any }) {
  if (loading) {
    return (
      <section className="mt-3 rounded-lg border border-zinc-200 bg-zinc-50 p-4">
        ...
        <p className="mt-2 text-sm text-zinc-600 animate-pulse">Solar가 스킬 계산 결과를 읽고 해설을 쓰고 있어요…</p>
      </section>
    );
  }
